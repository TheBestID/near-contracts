...
impl SBT {
    ...
    pub fn mint(&mut self, new_id: u128, account: &AccountId) {
        ...
        require!(
            self.minted_not_claimed[&new_id] == false,
    ...
    pub fn claim(&mut self, new_git_hash: &MyHash, new_email_hash: &MyHash) {
        ...
        require!(
            self.minted_not_claimed[&msg_sender_soul_id] == true,
    ...
    pub fn get_user_id(&self, account: &AccountId) -> u128 {
        return self.soul_id_of_account_[account];
    }
    ...
    pub fn has_soul(&self, account: &AccountId) -> bool {
        ...
        return self.account_of_soul_id[&account_soul_id] != *account;
    }

    // Soul doesn't have Seralization. TODO: Decide - implement Seralization or leave with next function?
